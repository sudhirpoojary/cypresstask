...
describe('Bayzat Task', () => {
    ...
    before(() => {
        ...
        cy.title().should('contain', 'Compare, Buy Health Insurance Dubai & HR Software for SMEs, UAE - Bayzat')
    ...
    beforeEach(() => {
     ...
     it('Add Employee', function () {
        ...
        for (var i = 1; i <= 2; i++) {
            ...
            cy.get('input[name="hiredAtFormatted"]').type(this.data.hired)
            ...
            cy.get('div.media-body > p').contains('Employee successfully added.')
        }
    })
